...
//    [loadingView addSubview: animatedImageView];
    ...
    LOTAnimationView *animation = [LOTAnimationView animationNamed:@"cooking_app"];
    animation.frame =CGRectMake ((backgroundView.bounds.size.width - 358)/2,(backgroundView.bounds.size.height - 244)/2, 358, 244);
    animation.center = backgroundView.center;
